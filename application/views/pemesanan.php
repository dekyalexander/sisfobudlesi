              ...
              <div class="col-lg-4 col-md-6 mb-4">
                <div class="card">
                  <form method="post" action="<?php echo base_url();?>pemesanan/tambah" method="post" accept-charset="utf-8">
                    <a href="#"><img class="img-responsive" src="<?php echo base_url() . 'assets/img/'.$row['gambar']; ?>" width="251px" height="251px"/></a>
                    <div class="card-body">
                      <h4 class="card-title">
                    ...
                    <div class="card-footer">
                      <a href="<?php echo base_url();?>pemesanan/detail_produk/<?php echo $row['id_produk'];?>" class="btn btn-sm btn-default"><i class="fa fa-search"></i> Detail</a> 
                      ...
                      <button type="submit" class="btn btn-sm btn-success"><i class="fa fa-shopping-cart"></i> Beli</button>
                    </div>
                  </form>
                </div>
              </div>
